F1_mask_taskPLSresult_striatum
...
load([PLSPATH, 'SD_2mm_BfMRIsessiondata.mat'],'st_coords'); %load st_coords
...
for i=1:length(ID)
    for k=1:length(conditions)
        load([PLSPATH, 'SD_', ID{i}, '_2mm_BfMRIsessiondata.mat'], 'st_datamat'); 
