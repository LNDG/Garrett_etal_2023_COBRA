...
%spatial
%load([BASEPATH, '/Dimensionality_nback/N181_PCAcorr_dimensionality_spatial.mat']);
...
%spatial
%batch_file.result_file=['behavPLS_COBRA_N163_PETSharp_nback_spatialPCAdim_', num2str(permutations), 'P', num2str(bootstrap), 'B_BfMRIresult.mat']; %name result file 
...
batch_file.behavdata=dimensionality(mask_181, :); %PCAdim
% %temporal
...
%spatial
 %batch_file.behavname={'1back_spatialPCAdim', '2back_spatialPCAdim', '3back_spatialPCAdim'};
 %save([PLSPATH, 'PET_6mm/behavPLS_COBRA_N163_PETSharp_nback_spatialPCAdim_', num2str(permutations), 'P', num2str(bootstrap), 'B_BfMRIanalysis.mat'], 'batch_file');
