function D_2_spatPCAdim_Shirer_selected_networks(ID)

%script for finding dimensionality of 90% of total PCA variance
%within a set of variables.

%/opt/matlab/R2016b/bin/mcc -m D_2_spatPCAdim_Shirer_selected_networks.m -a /toolboxes/NIFTI_toolbox -a /toolboxes/preprocessing_tools 
...
%for i=1:length(ID)
    for k=1:length(network_names)
      ...
      clear a;
      a = load([BASEPATH, '/PLS/scripts/mean_data/C',ID,'_nback_', VOX, 'mm_BfMRIsessiondata.mat']);%this loads a subject's sessiondata file.
