...
addpath('/Volumes/LNDG/Programs_Tools_Scripts/preprocessing_tools/')
addpath('/Volumes/LNDG/Programs_Tools_Scripts/NIFTI_toolbox/')
...
load([BASEPATH,'/mri+PETSharp/B_analyses/Paper1_2018/PLS_nback/SD_2mm/BGHAT_Morel/TaskPLS_COBRA_N152_23back_BGHATMorel_1000P1000B_BfMRIresult.mat'], 'result', 'st_coords')
