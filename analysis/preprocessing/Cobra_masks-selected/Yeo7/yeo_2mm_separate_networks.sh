...
#
mkdir -p net
for f in Yeo2011_7Networks_MNI152_FreeSurferConformed2mm_LiberalMask.nii.gz; do
    b=`basename $f`
    let i=1
...
flirt -in yeo2011_7_liberal_combined.nii.gz -ref yeo2011_7_liberal_combined.nii.gz -out yeo2011_7_liberal_combined_2mm.nii.gz -applyisoxfm 2