...
do
    ...
    # fsl command
    melodic -i swuaCOBRA_${subject}_resting_state_despiked_BPfiltered.nii.gz -o filtered_func_data.ica --dimest=mdl -v --nobet --bgthreshold=3 --tr=2.0 --report --guireport=../../report.html -d 0 --mmthresh=0.5 --Ostats
