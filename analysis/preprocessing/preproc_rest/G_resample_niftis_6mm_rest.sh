#!/bin/bash 
## downsamples detrended, filtered resting state niftis to 6mm resolution
...
for subject in $SUBJECTS; do
	...
	cd ${BASE}//imaging_files/Resting-state/filtered_denoised_detrend_data/C${subject}/
	flirt -in swuaCOBRA_${subject}_rest_despiked_BPfilt_denoised_detrend -ref swuaCOBRA_${subject}_rest_despiked_BPfilt_denoised_detrend -o swuaCOBRA_${subject}_rest_despiked_BPfilt_denoised_detrend_6mm -applyisoxfm 6
	#gunzip swuaCOBRA_${subject}_rest_despiked_BPfilt_denoised_detrend_6mm.nii
