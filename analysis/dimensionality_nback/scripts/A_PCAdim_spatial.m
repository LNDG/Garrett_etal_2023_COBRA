function A_PCAdim_spatial(ID)

%script for finding dimensionality of 90% of total PCA variance
%within a set of variables.

%/opt/matlab/R2014b/bin/mcc -m A_PCAdim_spatial.m -a /toolboxes/preprocessing_tools -a /toolboxes/NIFTI_toolbox
...
SAVEPATH = ([BASEPATH,'/dimensionality_nback/spatial_PCA/']);
